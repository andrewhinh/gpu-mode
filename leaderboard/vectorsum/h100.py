...
__global__ void vectorSumOptimized_H100_kernel(const float* __restrict__ input,
...
__global__ void finalReductionKernel(const float* __restrict__ workspace,
...
torch::Tensor vectorSum(torch::Tensor image) {
    ...
    vectorSumOptimized_H100_kernel<<<grid, block, sharedMemSize>>>(
    ...
    dim3 block2(1024);
    dim3 grid2(1);
    finalReductionKernel<<<grid2, block2>>>(
         workspace_tensor.data_ptr<float>(),
